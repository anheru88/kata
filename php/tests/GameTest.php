...
class GameTest extends TestCase
{
    ...
    /** @test  */
    function it_awards_a_one_extra_roll_bonus_for_last_spare()
    {
        $game = new Game();
    ...
    /** @test  */
    function it_awards_a_two_extra_roll_bonus_for_last_strike()
    {
        $game = new Game();
    ...
    /** @test  */
    function score_in_a_perfect_game()
    {
        $game = new Game();
